TourGuide:RegisterGuide("Thousand Needles (37-38)", "Dustwallow Marsh (38-38)", "Horde",function()

return [[

R Undercity |TID|1164| |N|Travel to Undercity (64.8, 49.6)| |Z|Undercity| |O|
T To Steal From Thieves |QID|1164| |N|Genavie Callow in Trade Quarter (63.76, 49.17)| |Z|Undercity| |O|
N Belgrom's Sealed Note |QID|1146| |N|Withdraw Belgrom's Sealed Note from the bank. Tick this step (66.0, 45.2)| |Z|Undercity| |L|5850| |OO|
N Fuel Regulator Blueprints |QID|1183| |N|Withdraw Fuel Regulator Blueprints from the bank. Tick this step (66.0, 45.2)| |Z|Undercity| |L|5852| |OO|
N Kravel's Parts |QID|1112| |N|Withdraw Kravel's Parts from the bank. Tick this step (66.0, 45.2)| |Z|Undercity| |L|5800| |OO|
N Sample Elven Gem |QID|669| |N|Store Sample Elven Gem in the bank. Tick this step (66.0, 45.2)| |Z|Undercity| |L|4502| |O|

R Orgrimmar |TID|1436| |N|Travel to Orgrimmar (22.26, 54.10)| |Z|Orgrimmar| |O|
...
A Hardened Shells |QID|1105| |N|Wizzle Brassbolts in Mirage Raceway (78.14, 77.07)|
A Load Lightening |QID|1176| |N|Pozzik in Mirage Raceway (80.14, 75.86)|
A Rocket Car Parts |QID|1110| |N|Kravel Koalbeard in Mirage Raceway (77.82, 77.18)|
A Salt Flat Venom |QID|1104| |N|Fizzle Brassbolts in Mirage Raceway (78.04, 77.08)|

N As you go... |AYG|1175| |QID|1110| |N|Collect 30 Rocket Car Parts through out The Shimmering Flats. You can complete the quests below in any order, click on the green button to switch quest waypoints and targets|
...
C A Bump in the Road |QID|1175| |N|Kill the required Saltstone crocs, Saltstone Gazer are found bottom part of the map and Saltstone Basilisk are found top of the map (76, 87) (86.4, 60.1) (73, 59)|
R The Shimmering Flats |QID|1175| |N|Travel to The Shimmering Flats (88, 75)|
C Rocket Car Parts |QID|1110| |N|Collect 30 Rocket Car Parts through out The Shimmering Flats (87, 77) (86, 60) (77.5, 54) (70, 62) (72, 78) (78, 85)|  |OBJ|450, 453, 454, 449|

T Rocket Car Parts |QID|1110| |N|Kravel Koalbeard in Mirage Raceway (77.85, 77.22)|
A Wharfmaster Dizzywig |QID|1111| |N|Kravel Koalbeard in Mirage Raceway (77.85, 77.22)|
A Hemet Nesingwary |QID|5762| |N|Kravel Koalbeard in Mirage Raceway (77.85, 77.22)|
...
A Razzeric's Tweaking |QID|1187| |N|Razzeric in Mirage Raceway (80.3, 76.1)| |PRE|1183|
T Encrusted Tail Fins |QID|1107| |N|Wizzle Brassbolts in Mirage Raceway (78.1, 77.1)| |O|
