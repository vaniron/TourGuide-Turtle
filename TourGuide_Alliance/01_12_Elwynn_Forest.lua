...
return [[
A A Threat Within |QID|783|
T A Threat Within |QID|783|
A Kobold Camp Cleanup |QID|7|
A Eagan Peltskinner |QID|5261|
T Eagan Peltskinner |QID|5261|
A Wolves Across the Border |QID|33|

C Kobold Camp Cleanup |N|Kobold camps to the North| |QID|7|
C Wolves Across the Border |QID|33|
...
T Investigate Echo Ridge |QID|15|
A Skirmish at Echo Ridge |QID|21|
T Milly Osworth |QID|3903|
A Milly's Harvest |QID|3904|

C Skirmish at Echo Ridge |N|To the north in Echo Ridge Mine (47.65, 32.00)| |QID|21|
C Milly's Harvest |N|In the farm to the southeast| |QID|3904|
C Bounty on Garrick Padfoot |N|At the small wooden shed behind the farm (57.50, 48.25)| |QID|6|

T Milly's Harvest |QID|3904|
A Grape Manifest |QID|3905|
...
A Pie for Billy |QID|86|

A Young Lovers |N|In the house at the Maclure Vineyard| |QID|106|
C Pie for Billy |QID|86|
T Pie for Billy |N|Back at the Stonefield Farm| |QID|86|
A Back to Billy |QID|84|
A Princess Must Die! |QID|88|
T Young Lovers |N|West of farm by the water (29.8, 86.0)| |QID|106|
A Speak with Gramma |N|Back to Farm House| |QID|111|
T Speak with Gramma |QID|111|
A Note to William |QID|107|
...
T Further Concerns |N|Take the road east to the bridge (73.9, 72.2)| |QID|35|
A Find the Lost Guards |QID|37|
...
T Harlan Needs a Resupply |N|Also along the Canals, to the north (49.58, 55.64)| |Z|Stormwind City| |QID|333|
...
F Westfall |R|Human|
T Return to Lewis |R|Human| |QID|6285|
...
C Deeprun Rat Roundup |U|17117| |QID|6661|
...
R Dun Morogh
A The Public Servant |N|Follow the road east to the Gol'Bolar Quarry (68,55)| |Z|Dun Morogh| |QID|433|
A Those Blasted Troggs! |QID|432|
C The Public Servant |N|Down below, in the cave| |QID|433|
...
A In Defense of the King's Lands |QID|263|
A The Trogg Threat |N|In the tower| |QID|267|
f Grab flight point |N|Up at Thelsamar (33.90, 50.00)| |Z|Loch Modan|
C In Defense of the King's Lands |N|To the west (27,53)| |Z|Loch Modan| |QID|263|
C The Trogg Threat |QID|267|
T In Defense of the King's Lands |QID|263|
