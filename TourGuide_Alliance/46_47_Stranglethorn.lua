...
T Ansirem's Key |QID|603| |N|Catelyn the Blade in The Salty Sailor Tavern (27.27, 77.52)|  |O|
A "Pretty Boy" Duncan |QID|610| |N|Catelyn the Blade in The Salty Sailor Tavern (27.27, 77.52)|  |PRE|603|
h The Salty Sailor Tavern |QID|610| |N|Speak to Innkeeper Skindle The Salty Sailor Tavern (27.05, 77.32)|
...
R Wild Shore |QID|614| |N|Travel to Wild Shore (33.77, 74.85)|
...
K Captain Keelhaul |QID|608.2| |N|Kill Captain Keelhaul in the middle floor of the ship in Wild Shore (29.87, 89.35) (29.20, 88.38)|  |PRE|604|
...
A Cortello's Riddle |QID|624| |N|Use Cortello's Riddle to accept quest|  |U|4056| |O|
...
C Up to Snuff |QID|587| |N|Collect 15 Snuff from any pirates in Wild Shore (33.14, 88.25)|

R Booty Bay |QID|611| |N|Travel to Booty Bay (27.27, 77.52)|
...
N 10 Gorilla Fang |QID|348| |N|Kill Elder Mistvale Gorilla until you collect 10 Gorilla Fang for the quest 'Strangelthorn Fever' in Mistvale Valley (33.69, 65.08)|  |L|2799 10|
T Stranglethorn Fever |QID|349| |N|Witch Doctor Unbagwa in Spirit Den, this will start the event (35.28, 60.39)|  |D| |E|
...
R Booty Bay |TID|348| |N|Travel to Booty Bay (27.64, 76.75)|
T The Curse of the Tides |QID|611| |N|Baron Revilgaz in Booty Bay (27.20, 76.90)|  |PRE|603|
T Stranglethorn Fever |QID|348| |N|Fin Fizracket in Booty Bay (27.64, 76.75)|
